...
pygame.display.set_caption("Pygame проект: Змейка")
pygame.image.load("123.jpg")
background_image = pygame.image.load("123.jpg").convert()
 
colors = {
    "snake_head": (255, 165, 0),
    "snake_tail": (255, 255, 0),
    "apple": (255, 0, 0)
}
